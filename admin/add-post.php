		...
		<div id="wrapper">
			...
			<form action='' method="POST" enctype="multipart/form-data">
				...
				<div class="form-group">
					...
					<textarea  class="form-control" id="postDescription" name="postDescription" rows='10'><?php if(isset($error)){ echo $_POST['postDesc'];}?></textarea>
				</div>
				<div class="form-group">
					<label for="postContent">Content</label><br />
					<textarea name="postContent" class="form-control" rows='10'><?php if(isset($error)){ echo $_POST['postCont'];}?></textarea>
				</div>
				<div class="form-group">
					<label for="postCategory">Category</label>
					<input type='text' class="form-control" id="postCategory" name="postCategory" value='<?php if(isset($error)){ echo $_POST['postCategory'];}?>'>
				</div>
